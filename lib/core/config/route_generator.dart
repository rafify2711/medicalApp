  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    BlocProvider<DoctorProfileCubit>(create: (context)=>getIt<DoctorProfileCubit>()),
      ...
      case RouteNames.diseasePredictionList:
        return MaterialPageRoute(builder: (_) => BlocProvider<PredictionCubit>(create: (context) => getIt<PredictionCubit>(),child: DiseasePredictionListScreen()));
      ...
      case RouteNames.userAppointment:
        return MaterialPageRoute(builder: (_) => BlocProvider<UserAppointmentCubit>(create: (context)=>getIt<UserAppointmentCubit>(),child: UserAppointmentScreen()));

      case RouteNames.doctorSchedule:
        return MaterialPageRoute(builder: (_) => BlocProvider<ScheduleCubit>(create: (context)=>getIt<ScheduleCubit>(),child: DoctorScheduleScreen()));
      ...
      case RouteNames.doctorList:
        return MaterialPageRoute(builder: (_) => BlocProvider<ScheduleCubit>(create: (context)=>getIt<ScheduleCubit>(),child: DoctorListScreen()));
    ...
    ,child: DrugTabsScreen())
      ...
      case RouteNames.updateProfile:
        return MaterialPageRoute(builder: (_) => BlocProvider<UpdateUserProfileCubit>(create: (context)=>getIt<UpdateUserProfileCubit>(),child: UpdateProfileScreen()));
    ...
    BlocProvider<ScheduleCubit>(create: (context)=>getIt<ScheduleCubit>())
      ...
      case RouteNames.makeReservation:
        final args = settings.arguments as Map<String, dynamic>;
        return MaterialPageRoute(
          builder: (_) => BlocProvider<CreateReservationCubit>(create: (context)=>getIt<CreateReservationCubit>(),
