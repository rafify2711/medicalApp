...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'oralDiseases': 'Oral Diseases',
      'oralDiseasesDescription': 'Analyze oral conditions and diseases from dental images',
      'dental': 'Dental',
      'dentalDescription': 'Detect dental problems and conditions from X-ray images',
      'colonDiseases': 'Colon Diseases',
      'colonDescription': 'Analyze colon conditions from medical imaging',
      'male': 'Male',
      'female': 'Female',
      'other': 'Other',
      ...
      'logoutWarning': 'You will need to login again to access your account.',
    ...
    'ar': {
      ...
      'oralDiseases': 'أمراض الفم',
      'oralDiseasesDescription': 'تحليل حالات وأمراض الفم من صور الأشعة السينية',
      'dental': 'الأسنان',
      'dentalDescription': 'كشف مشاكل وأمراض الأسنان من صور الأشعة السينية',
      'colonDiseases': 'أمراض الأمعاء',
      'colonDescription': 'تحليل حالات الأمعاء من الصور الطبية',
      'male': 'ذكر',
      'female': 'أنثى',
      'other': 'آخر',
  ...
  String get oralDiseases => get('oralDiseases');
  String get oralDiseasesDescription => get('oralDiseasesDescription');
  String get dental => get('dental');
  String get dentalDescription => get('dentalDescription');
  String get colonDiseases => get('colonDiseases');
  String get colonDescription => get('colonDescription');
  ...
  String get bloodType => get('bloodType');
  String get allergies => get('allergies');
  String get chronicDiseases => get('chronicDiseases');
  String get medications => get('medications');
  String get deleteSchedule => get('deleteSchedule');
  String get deleteScheduleConfirmation => get('deleteScheduleConfirmation');
  String get cancelConfirmation => get('cancelConfirmation');
